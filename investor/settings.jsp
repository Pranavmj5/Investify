...
<body class="bg-bg-light font-display text-text-main min-h-screen antialiased">
    <header
        ...
        <a href="profile.jsp" class="h-9 w-9 rounded-full ring-2 ring-transparent hover:ring-primary transition-all flex items-center justify-center bg-primary text-white font-bold text-sm uppercase" title="Profile">
        ...
        <div class="bg-surface rounded-2xl border border-border-c shadow-sm p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between py-3 border-b border-border-c">
                    <div>
                        <p class="font-semibold text-sm">Investment Updates</p>
                        <p class="text-xs text-text-muted">Get notified when investments are confirmed or changed</p>
                    </div>
                ...
                <div class="flex items-center justify-between py-3 border-b border-border-c">
                    <div>
                        <p class="font-semibold text-sm">New Startup Listings</p>
                        <p class="text-xs text-text-muted">Alerts when startups in your domains are listed</p>
                    </div>
                    <div class="toggle-track on" onclick="this.classList.toggle('on')">
                        <div class="toggle-thumb"></div>
                    </div>
                ...
                <div class="flex items-center justify-between py-3 border-b border-border-c">
                    <div>
                        <p class="font-semibold text-sm">Founder Messages</p>
                        <p class="text-xs text-text-muted">Notify me when founders reply to my interest</p>
                    </div>
                    <div class="toggle-track on" onclick="this.classList.toggle('on')">
                        <div class="toggle-thumb"></div>
                    </div>
                ...
                <div class="flex items-center justify-between py-3 border-b border-border-c">
                    <div>
                        <p class="font-semibold text-sm">Portfolio Reports</p>
                        <p class="text-xs text-text-muted">Monthly portfolio performance summaries</p>
                    </div>
                ...
                <div class="flex items-center justify-between py-3">
                    <div>
                        <p class="font-semibold text-sm">Marketing Emails</p>
                        <p class="text-xs text-text-muted">Product updates and promotional content</p>
                    </div>
                    <div class="toggle-track" onclick="this.classList.toggle('on')">
                        <div class="toggle-thumb"></div>
                    </div>
